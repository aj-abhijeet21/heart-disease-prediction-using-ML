...
if (isset($_POST['reg_user']))
{
    ...
    // if (empty($username)) { array_push($grey-text2s, "Username is required"); }
    // if (empty($email)) { array_push($grey-text2s, "Email is required"); }
    // if (empty($password_1)) { array_push($grey-text2s, "Password is required"); }
 ...
 -->                    <a href= "login.php"><button class="waves-effect btn-large btn-large-white px-4 tm-border-radius-0" >Login</button></a>
            ...
            <div class="col-xl-7 col-lg-6 col-md-6 col-sm-12 ">
                ...
                <form  method="post" class="tm-signup-form ">
                    ...
                    <div class="input-field">
                        <input placeholder="Username" id="email" name="email" type="text" class="validate" required>
                        <p class="grey-text2"></p>
                    </div>
                    <div class="input-field">
                        <input placeholder="Password" id="password1" name="password1" type="password" class="validate" required>
                        <p class="grey-text2"></p>
                    </div>
                    <div class="input-field">
                        <input placeholder="Re-type Password" id="password2" name="password2" type="password" class="validate" required>
                        <p class="grey-text2"></p>
                    </div>
                    <div class="input-field">
                        <input placeholder="Phone" id="phone" name="phone" type="tel" class="validate" required>
                        <p class="grey-text2"></p>
                    </div>
                    <div class="input-field">
...
>
                    ...
                    <label>
                        <input type="checkbox" name="tnc" class="filled-in" checked="false" />
                        <span>I agree to Terms & Conditions</span>
                    </label>                    
                    <div class="text-right mt-4">
                        <button type="submit" name="reg_user" class="waves-effect btn-large btn-large-white px-4 tm-border-radius-0" onclick="ValidateForm()">Sign Up</button>
                    </div>
                </form> 
            </div>
        </div>
